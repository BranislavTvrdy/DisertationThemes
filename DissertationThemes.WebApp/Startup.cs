...
namespace DissertationThemes.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<DissertationThemes.Database.Model.NorthwindContext>();
            //services.AddTransient<DissertationThemesService>();
